    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item me-2 me-xl-0">
          <x-partials.header.header-button-dark notification='1' class="bx bx-sm">
          </x-partials.header.header-button-dark>
        </li>
        <!--/ Style Switcher -->

        <!-- Quick links  -->
        <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0">
          <x-partials.header.header-dropdown message='' class="bx bx-grid-alt bx-sm">
          </x-partials.header.header-dropdown>
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <x-partials.header.header-dropdown-avatar src="../../assets/img/avatars/1.png" alt="avatar"
            class="bx bx-grid-alt bx-sm"></x-partials.header.header-dropdown-avatar>
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
            ...
            <li>
              <form action="{{route('logout')}}" method="post">
                ...
                <a class="dropdown-item" target="_blank">
                  ...
                  <button class="btn" style="background-color:transparent" type="submit">Log
                    Out</button>
                </a>
              </form>
            </li>
