<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-breeze.input-label for="first_name" :value="__('Name')" />
            <x-breeze.text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')" required
                autofocus />
            <x-breeze.input-error :messages="$errors->get('first_name')" class="mt-2" />
        </div>

        <div>
            <x-breeze.input-label class="mt-1" for="last_name" :value="__('Last Name')" />
            <x-breeze.text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name"
                :value="old('last_name')" required autofocus />
            <x-breeze.input-error :messages="$errors->get('last_name')" class="mt-2" />
        </div>
